...
public class kadai3 {
    public static void main(String args[]){
       ...
       try{
           ...
           db_con=DriverManager.getConnection("jdbc:mysql://localhost:3306/jojo0920_db","root","");
           
           db_st=db_con.prepareStatement("SELECT profilesID,name,tel,age,birthday FROM profiles");
